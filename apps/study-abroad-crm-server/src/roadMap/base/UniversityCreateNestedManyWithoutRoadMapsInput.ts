...
@InputType()
class UniversityCreateNestedManyWithoutRoadMapsInput {
...
export { UniversityCreateNestedManyWithoutRoadMapsInput as UniversityCreateNestedManyWithoutRoadMapsInput };
