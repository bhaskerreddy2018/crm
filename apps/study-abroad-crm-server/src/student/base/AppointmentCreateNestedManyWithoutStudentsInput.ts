...
@InputType()
class AppointmentCreateNestedManyWithoutStudentsInput {
...
export { AppointmentCreateNestedManyWithoutStudentsInput as AppointmentCreateNestedManyWithoutStudentsInput };
